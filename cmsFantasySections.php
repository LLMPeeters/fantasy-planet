...
<html>
	<head>
		...
		<title>Fantasy Sections CMS</title>
		...
		<main>
			<section class="page-flip">
				<section class="page toggle">
					...
					<form class="add-form fantasy-sections" method="post" action="cmsFantasySections.php" autocomplete="off">
				...
				<section class="page">
					<h1>Update or delete section</h1>
					
					<form class="update-form fantasy-sections" method="post" action="cmsFantasySections.php" autocomplete="off">
						<input type="text" name="name" placeholder="Name">
						<textarea class="ck-edit" name="text"></textarea>
