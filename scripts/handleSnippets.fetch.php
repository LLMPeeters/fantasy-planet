...
$collection = $webber->selectCollection( 'snippets' );
    ...
    if(
        ...
        if( $checkSession !== null )
        {
            ...
            if( $checkUser !== null )
            {
                ...
                $newSnippet->createdAt = new MongoDB\BSON\UTCDateTime();
                $newSnippet->editedAt = array( new MongoDB\BSON\UTCDateTime() );
                
                $collection->insertOne( $newSnippet );
